...
**Status:** Shipped
**Created:** 2026-09-09
**Input:** Multi-user authentication and session management so each user can sign in and access private recipe list, and ingredient list
...
**So that** I can sign in and manage my own private recipes, and that I can manage my own private ingredients.
...
- Password reset (`POST /recipe/reset-password`)
- Email verification
- OAuth / social login
